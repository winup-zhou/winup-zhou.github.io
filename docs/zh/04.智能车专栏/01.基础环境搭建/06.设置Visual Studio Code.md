...
![示意图](/origincar/env/vscode/01-image26.webp)

等待 VSCode 打开后，我们点击左侧的扩展按钮，进入扩展页面：

![示意图](/origincar/env/vscode/02-image27.webp)

点击 WSL: UBUNTU-22.04 – 已安装旁边的云朵图标，此时页面上方会弹出选择需要安装的本地扩展：

![示意图](/origincar/env/vscode/03-image28.webp)
...
![示意图](/origincar/env/vscode/04-image29.webp)
